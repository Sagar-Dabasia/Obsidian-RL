...
# truncate everything from the first def test_manifest_duplicate_exact_match_rejected
idx = content.find("def test_manifest_duplicate_exact_match_rejected")
if idx != -1:
    content = content[:idx]
